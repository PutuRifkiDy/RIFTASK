    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 gap-x-4 gap-y-8">
                <HeaderForm title='Information' subtitle='Add your card information here' />
                    ...
                    <CardContent>
                        <form onSubmit={onHandleSubmit}>
                            ...
                            <div className="flex items-center justify-end gap-x-2 py-6">
                                ...
                                <Transition show={recentlySuccessful} enter="transition ease-in-out" enterForm="opacity-0" leave="transition ease-in-out" leaveTo="opacity-0">
