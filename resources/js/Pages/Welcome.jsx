        ...
        <div>
            ...
            <main className="isolate">
                <div className="relative pt-14">
                        ...
                        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            <div className="mx-auto max-w-2xl text-center">
                                ...
                                <p className="mt-6 text-lg leading-8 text-muted-foreground">
                                    ...
                                    to-dos. With Riftasks, you can effortlessly organize your tasks into clear
                                    categories. Boost your team's efficiency, track project progress, and witness your
                                    ideas come to life.
                                </p>
                    ...
                    >
                        <div
                            className="to-indigo-600opacity-30 relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-indigo-400 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
                            style={{
                                clipPath:
                                    'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
                            }}
